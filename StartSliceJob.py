    ...
    def run(self) -> None:
        ...
        with self._scene.getSceneLock():
            ...
            if stack.getProperty("print_sequence", "value") == "one_at_a_time":
                ...
                print_convex_hulls = bool(stack.getProperty("belt_raft", "value"))
                for node in DepthFirstIterator(self._scene.getRoot()): #type: ignore #Ignore type error because iter() should get called automatically by Python syntax.
            ...
            on_belt_plugin = bool(stack.getProperty("belt_plugin_enable", "value"))
                ...
                for group in filtered_object_groups:
                    ...
                    for object in group:
                        ...
                        if type(object) is ConvexHullNode:
                            raft_thickness = stack.getProperty("belt_raft_thickness", "value") or 0.8
                            raft_margin = stack.getProperty("belt_raft_margin", "value") or 0.0
                            ...
                            if per_object_stack:
                                ...
                                belt_support_gantry_angle_bias = stack.getProperty("belt_gantry_angle", "value") or 45
                                belt_support_minimum_island_area = stack.getProperty("belt_support_minimum_island_area", "value") or 3.0 
                            else:
            ...
            if bool(stack.getProperty("belt_raft", "value")):
                raft_offset = stack.getProperty("belt_raft_thickness", "value") or 0.8
                raft_speed = stack.getProperty("belt_raft_speed", "value") or 18.0
                #raft_flow = stack.getProperty("belt_raft_flow", "value") or 1.0 * math.sin(gantry_angle)
