...
class CuraApplicationPatches():
    ...
    def arrange(self, nodes, fixed_nodes):
        ...
        if bool(self._application.getGlobalContainerStack() and self._application.getGlobalContainerStack().getProperty("belt_plugin_enable", "value")):
    ...
    def _readMeshFinished(self, job):
        ...
        is_belt_printer = bool(self._application.getGlobalContainerStack() and self._application.getGlobalContainerStack().getProperty("belt_plugin_enable", "value"))
        ### END PATCH
